...
export default function EditFood() {
  ...
  // Fetch food details and diseases
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await API.put(`/api/foods/${id}`, fd, {
  ...
  if (loading) {
    return (
      <>
        <Navbar />
        <div className="min-h-screen bg-[#FEF1E1] flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                type="submit"
                className="px-8 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg hover:from-green-700 hover:to-blue-700 transition font-medium shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                disabled={submitting}
              >
                {submitting ? (
                  <>
