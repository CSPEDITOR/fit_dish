    ...
    <div className="min-h-screen min-w-screen flex justify-center pb-16">
      ...
      <div className="max-w-6xl  w-full grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="bg-white  p-8 rounded-3xl shadow-lg border">
          <h2 className="text-2xl font-bold mb-6 text-[#CC2405]">Send Us a Message</h2>
        ...
        <div className=" flex  justify-center bg-[#CB3432] hover:bg-[#FBEBEB] text-white hover:text-black p-8 rounded-3xl shadow-lg ">
          ...
          {/* <div className="space-y-4">
            <p><span className="font-semibold">📧 Email:</span> support@fitdish.com</p>
            <p><span className="font-semibold">📞 Phone:</span> +91 98765 43210</p>
            <p><span className="font-semibold">📍 Address:</span> Bhubaneswar, Odisha, India</p>
          </div>

         
          <h3 className="font-semibold mt-8 mb-3">Follow Us</h3>
